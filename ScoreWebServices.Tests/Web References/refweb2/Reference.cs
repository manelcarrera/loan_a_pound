...
namespace ScoreWebServices.Tests.refweb2 {
    using System;
    ...
    public partial class WebService2 : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public WebService2() {
            this.Url = global::ScoreWebServices.Tests.Properties.Settings.Default.ScoreWebServices_Tests_refweb2_WebService2;
        ...
        public int getScore() {
            object[] results = this.Invoke("getScore", new object[0]);
        ...
        public void getScoreAsync(object userState) {
            ...
            this.InvokeAsync("getScore", new object[0], this.getScoreOperationCompleted, userState);
        }
